package com.example.techtron.tictactoe;
...
public class BoardView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        height = new View.MeasureSpec.getSize(heightMeasureSpec);
        width = new View.MeasureSpec.getSize(widthMeasureSpec);
    ...
    private void drawElt(Canvas canvas, char c, int x, int y){
        if (c=='0'){
            ...
            float endX2 = startX - eltW + ELT_MARGIN * 2;
            float endY2 = startY + eltH - ELT_MARGIN;
